...
export function TheorySection({
  ...
  const getVisualDescriptionLocal = (visualType: string): string => {
    // Use the centralized description function
    return getVisualDescription(visualType);
  };

  const getVisualDescriptionOld = (visualType: string): string => {
    switch (visualType) {
  ...
  const renderVisualAid = (
    ...
    const renderVisualComponentNew = () => {
      // Use the centralized visual component registry
      return renderVisualComponent(visualType, { className: 'mt-4' });
    };

    const renderVisualComponentOld = () => {
      switch (visualType) {
        // Place value and number structure
        case 'PlaceValueChart':
        case 'place-value-chart':
