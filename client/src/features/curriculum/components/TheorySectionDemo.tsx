...
export function TheorySectionDemo() {
  return (
    <div className='min-h-screen bg-gray-50 dark:bg-gray-900 py-8'>
      <div className='max-w-4xl mx-auto px-4'>
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-gray-900 dark:text-white mb-2'>
            Enhanced Theory Section Demo
          </h1>
          <p className='text-gray-600 dark:text-gray-400'>
            Demonstrating the enhanced TheorySection component with interactive
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
          <MathJaxProvider>
            <TheorySection concepts={sampleConcepts} chapterNumber={1} />
          </MathJaxProvider>
        </div>
  ...
  return (
    <MathJaxProvider>
      <div className='max-w-4xl mx-auto p-6 bg-gray-50 dark:bg-gray-900 min-h-screen'>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
          <TheorySection concepts={mockConcepts} chapterNumber={1} />
        </div>
      </div>
    </MathJaxProvider>
  );
